...
class CostGoodsSold extends StatefulWidget {
  CostGoodsSold({Key? key}) : super(key: key);

  @override
  State<CostGoodsSold> createState() => _CostGoodsSoldState();
}

class _CostGoodsSoldState extends State<CostGoodsSold> {
  String? chose;
  String? chose1;
  String? chose2;
  int? selectedIndex;
  ...
  List data = [
    {"1": "االيرادات", "2": "١٢٠٠", "3": "100", "4": "200"},
    {"1": "االيرادات", "2": "١٢٠٠", "3": "100", "4": "200"},
    {"1": "االيرادات", "2": "١٢٠٠", "3": "100", "4": "200"},
    {"1": "االيرادات", "2": "١٢٠٠", "3": "100", "4": "200"},
  ];
