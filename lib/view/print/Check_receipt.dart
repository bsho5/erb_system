...
class CheckReceipt extends StatefulWidget {
  @override
  State<CheckReceipt> createState() => _CheckReceiptState();
}

class _CheckReceiptState extends State<CheckReceipt> {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                DefaultContainer(title: 'ايصال استلام شيك'),
                                SizedBox(
