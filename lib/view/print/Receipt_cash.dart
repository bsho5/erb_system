...
class CheckCash extends StatefulWidget {
  @override
  State<CheckCash> createState() => _CheckCashState();
}

class _CheckCashState extends State<CheckCash> {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                DefaultContainer(title: 'ايصال استلام نقديه'),
                                SizedBox(
