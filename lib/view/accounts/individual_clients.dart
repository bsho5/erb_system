...
class IndividualClients extends StatefulWidget {
  const IndividualClients({Key? key}) : super(key: key);

  @override
  State<IndividualClients> createState() => _IndividualClientsState();
}

class _IndividualClientsState extends State<IndividualClients> {
  String? chose;
  String? chose1;
  String? chose2;
  int? selectedIndex;
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ...
                              DefaultContainer(title: 'العملاء الافراد'),
                              const SizedBox(
                                height: 50,
                              ),
                              Row(
